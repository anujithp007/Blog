...
const DetailPage = () => {
 ...
 console.log(id1,'id1');
    ...
    console.log(data,'k');
   const dateString = data.createdDate || ''; // Set a default value if createdDate is undefined
const date = dateString ? new Date(dateString) : null; // Check if dateString is not empty before creating a Date object
const formattedDate = date ? date.toISOString().split('T')[0] : ''; // Format the date only if date is not null
  return (
